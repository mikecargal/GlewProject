...
void quad(int a, int b, int c, int d)
{
	...
	colors[Index] = vertex_colors[a]; points[Index] = vertices[a]; normals[Index] = normal; tangents[Index] = tangent; Index++;
	colors[Index] = vertex_colors[b]; points[Index] = vertices[b]; normals[Index] = normal; tangents[Index] = tangent; Index++;
	colors[Index] = vertex_colors[c]; points[Index] = vertices[c]; normals[Index] = normal; tangents[Index] = tangent; Index++;
	colors[Index] = vertex_colors[a]; points[Index] = vertices[a]; normals[Index] = normal; tangents[Index] = tangent; Index++;
	colors[Index] = vertex_colors[c]; points[Index] = vertices[c]; normals[Index] = normal; tangents[Index] = tangent; Index++;
	colors[Index] = vertex_colors[d]; points[Index] = vertices[d]; normals[Index] = normal; tangents[Index] = tangent; Index++;
}
